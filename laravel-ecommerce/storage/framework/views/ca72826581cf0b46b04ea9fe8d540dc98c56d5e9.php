            ...
            <a-row :gutter="20" class="mt-1">
                    ...
                    <a-card title="Apply Promotion Code">
                        ...
                        <div>
                            <form method="get" :form="form" @submit="handleCouponSubmit" action="">
                                ...
                                <a-form-item>
                                    <a-button html-type="submit" type="primary"><?php echo e(__('Apply')); ?></a-button>
                                </a-form-item>
                            </form>
                        </div>
                        <?php else: ?>
                ...
                <a-col :span="8" :push="4">
                    <a class="btn-checkout" href="<?php echo e(route('checkout.show')); ?>">
                        <a-button type="primary"><?php echo e(__('Checkout')); ?></a-button>
                    </a>
                </a-col>
            </a-row>
            <a-modal
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-ecommerce\resources\views/cart/show.blade.php ENDPATH**/ ?>