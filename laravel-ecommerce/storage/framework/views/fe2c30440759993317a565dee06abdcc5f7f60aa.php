    ...
    <a-col :span="12">
        <a-form-item
            ...
            <a-select
                ...
                v-decorator="[
                'category',
                <?php echo e(($product->categories !== null && count($product->categories) > 0) ? "{'initialValue': [\"". implode('","', $product->categories->pluck('id')->toArray()) . "\"]}," : ""); ?>
...
<?php /**PATH D:\laravel-ecommerce\vendor\avored\framework\src/../resources/views/catalog/product/_fields.blade.php ENDPATH**/ ?>