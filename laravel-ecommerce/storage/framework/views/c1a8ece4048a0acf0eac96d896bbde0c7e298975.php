<a-card class="mt-1 mb-1" title="<?php echo e(__('avored::catalog.product.attribute_card_title')); ?>">
    <p>
        <a-form-item label="<?php echo e(__('avored::catalog.product.attribute_card_title')); ?>">
        <a-select @change="changeVariation" :default-value="attributeIds" mode="multiple"  placeholder="Please select">
            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a-select-option :value="<?php echo e($attribute->id); ?>" key="<?php echo e($attribute->id); ?>">
        ...
        <div class="add-on-button">
            <a-button @click="handleVariationBtnClick" type="primary">
                <?php echo e(__('avored::catalog.product.variation_btn')); ?>

            </a-button>
        </div>
    </p>

    <h4><?php echo e(__('avored::catalog.product.variation_title')); ?></h4>
...
<a-modal title="<?php echo e(__('avored::catalog.product.variation_model_title')); ?>"
    v-model="variationModelVisible"
    ok-text="<?php echo e(__('avored::catalog.product.variation_save_btn')); ?>"
    @ok="clickVariationSave">
        ...
        <a-form  :form="variationForm">
            ...
            <a-row :gutter="15">
                <a-col :span="24">
                    <a-form-item label="<?php echo e(__('avored::catalog.product.variation_image')); ?>">
                        <a-upload
                            name="file"
                            :multiple="false"
                            ...
                            >
                            <a-button>
                                <a-icon type="upload"></a-icon> <?php echo e(__('avored::catalog.product.variation_image_upload')); ?>
                    ...
                    <a-form-item>
                        <a-input
                            ...
                            {rules: 
                                [
                                    {   required: true, 
                                        message: '<?php echo e(__('avored::validation.required', ['attribute' => 'id'])); ?>' 
                                    }
                                ]
                            }
                            ]"></a-input>
...
<?php /**PATH D:\laravel-ecommerce\vendor\avored\framework\src/../resources/views/catalog/product/cards/attribute.blade.php ENDPATH**/ ?>